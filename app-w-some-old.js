...
seattleStore.setCookiesSalesPerHour();
seattleStore.setTotalDaily();

const tokyoStore = new Store (`Tokyo`, 3, 24, 1.2, `6:00am - 8:00pm`);
tokyoStore.setCookiesSalesPerHour();
tokyoStore.setTotalDaily();
    
const dubaiStore = new Store (`Dubai`, 11, 38, 3.7, `6:00am - 8:00pm`);
dubaiStore.setCookiesSalesPerHour();
dubaiStore.setTotalDaily();
    
const parisStore = new Store (`Paris`, 20, 38, 2.3, `6:00am - 8:00pm`);
parisStore.setCookiesSalesPerHour();
parisStore.setTotalDaily();
    
const limaStore = new Store (`Lima`, 2, 16, 4.6, `6:00am - 8:00pm`);
limaStore.setCookiesSalesPerHour();
limaStore.setTotalDaily();
